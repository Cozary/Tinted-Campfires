...
public class RedCampfireBlockEntity extends AbstractTintedCampfireBlockEntity {
    public RedCampfireBlockEntity(BlockPos pos, BlockState state) {
        super(ModBlockEntities.RED_CAMPFIRE_TILE.get(), pos, state);
    }
}
