...
public class YellowCampfireBlockEntityRenderer implements BlockEntityRenderer<YellowCampfireBlockEntity> {
    ...
    @Override
    public void render(YellowCampfireBlockEntity colorCampfireTileEntity, float partialTick, PoseStack poseStack, MultiBufferSource multiBufferSource, int packedLight, int packedOverlay) {
