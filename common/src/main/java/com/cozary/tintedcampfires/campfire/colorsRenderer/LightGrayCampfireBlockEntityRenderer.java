...
public class LightGrayCampfireBlockEntityRenderer implements BlockEntityRenderer<LightGrayCampfireBlockEntity> {
    ...
    @Override
    public void render(LightGrayCampfireBlockEntity colorCampfireTileEntity, float partialTick, PoseStack poseStack, MultiBufferSource multiBufferSource, int packedLight, int packedOverlay) {
