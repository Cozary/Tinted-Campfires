...
public class GreenCampfireBlockEntityRenderer implements BlockEntityRenderer<GreenCampfireBlockEntity> {
    ...
    @Override
    public void render(GreenCampfireBlockEntity colorCampfireTileEntity, float partialTick, PoseStack poseStack, MultiBufferSource multiBufferSource, int packedLight, int packedOverlay) {
