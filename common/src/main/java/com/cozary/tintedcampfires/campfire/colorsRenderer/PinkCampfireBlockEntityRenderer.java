...
public class PinkCampfireBlockEntityRenderer implements BlockEntityRenderer<PinkCampfireBlockEntity> {
    ...
    @Override
    public void render(PinkCampfireBlockEntity colorCampfireTileEntity, float partialTick, PoseStack poseStack, MultiBufferSource multiBufferSource, int packedLight, int packedOverlay) {
