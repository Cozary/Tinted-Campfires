...
public class CyanCampfireBlockEntityRenderer implements BlockEntityRenderer<CyanCampfireBlockEntity> {
    ...
    @Override
    public void render(CyanCampfireBlockEntity colorCampfireTileEntity, float partialTick, PoseStack poseStack, MultiBufferSource multiBufferSource, int packedLight, int packedOverlay) {
