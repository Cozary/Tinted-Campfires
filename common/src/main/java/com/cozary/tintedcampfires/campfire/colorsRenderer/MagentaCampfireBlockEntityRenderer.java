...
public class MagentaCampfireBlockEntityRenderer implements BlockEntityRenderer<MagentaCampfireBlockEntity> {
    ...
    @Override
    public void render(MagentaCampfireBlockEntity colorCampfireTileEntity, float partialTick, PoseStack poseStack, MultiBufferSource multiBufferSource, int packedLight, int packedOverlay) {
