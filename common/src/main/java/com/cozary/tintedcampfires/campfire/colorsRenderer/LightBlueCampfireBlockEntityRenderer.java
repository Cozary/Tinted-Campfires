...
public class LightBlueCampfireBlockEntityRenderer implements BlockEntityRenderer<LightBlueCampfireBlockEntity> {
    ...
    @Override
    public void render(LightBlueCampfireBlockEntity colorCampfireTileEntity, float partialTick, PoseStack poseStack, MultiBufferSource multiBufferSource, int packedLight, int packedOverlay) {
