...
public class LimeCampfireBlockEntityRenderer implements BlockEntityRenderer<LimeCampfireBlockEntity> {
    ...
    @Override
    public void render(LimeCampfireBlockEntity colorCampfireTileEntity, float partialTick, PoseStack poseStack, MultiBufferSource multiBufferSource, int packedLight, int packedOverlay) {
