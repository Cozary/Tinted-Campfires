...
public class RedCampfireBlockEntityRenderer implements BlockEntityRenderer<RedCampfireBlockEntity> {
    ...
    @Override
    public void render(RedCampfireBlockEntity colorCampfireTileEntity, float partialTick, PoseStack poseStack, MultiBufferSource multiBufferSource, int packedLight, int packedOverlay) {
