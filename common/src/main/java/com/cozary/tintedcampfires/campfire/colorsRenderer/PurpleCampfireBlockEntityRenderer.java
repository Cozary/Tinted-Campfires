...
public class PurpleCampfireBlockEntityRenderer implements BlockEntityRenderer<PurpleCampfireBlockEntity> {
    ...
    @Override
    public void render(PurpleCampfireBlockEntity colorCampfireTileEntity, float partialTick, PoseStack poseStack, MultiBufferSource multiBufferSource, int packedLight, int packedOverlay) {
