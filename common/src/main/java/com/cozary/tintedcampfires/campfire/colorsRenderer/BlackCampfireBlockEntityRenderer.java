...
public class BlackCampfireBlockEntityRenderer implements BlockEntityRenderer<BlackCampfireBlockEntity> {
    ...
    @Override
    public void render(BlackCampfireBlockEntity colorCampfireTileEntity, float partialTick, PoseStack poseStack, MultiBufferSource multiBufferSource, int packedLight, int packedOverlay) {
