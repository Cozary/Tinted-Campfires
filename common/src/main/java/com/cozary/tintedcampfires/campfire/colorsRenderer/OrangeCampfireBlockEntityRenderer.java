...
public class OrangeCampfireBlockEntityRenderer implements BlockEntityRenderer<OrangeCampfireBlockEntity> {
    ...
    @Override
    public void render(OrangeCampfireBlockEntity colorCampfireTileEntity, float partialTick, PoseStack poseStack, MultiBufferSource multiBufferSource, int packedLight, int packedOverlay) {
