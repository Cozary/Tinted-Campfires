...
public class GrayCampfireBlockEntityRenderer implements BlockEntityRenderer<GrayCampfireBlockEntity> {
    ...
    @Override
    public void render(GrayCampfireBlockEntity colorCampfireTileEntity, float partialTick, PoseStack poseStack, MultiBufferSource multiBufferSource, int packedLight, int packedOverlay) {
