...
public class WhiteCampfireBlockEntityRenderer implements BlockEntityRenderer<WhiteCampfireBlockEntity> {
    ...
    @Override
    public void render(WhiteCampfireBlockEntity colorCampfireTileEntity, float partialTick, PoseStack poseStack, MultiBufferSource multiBufferSource, int packedLight, int packedOverlay) {
