...
public class ModTabs {
    ...
    public static final RegistryObject<CreativeModeTab> TINTED_CAMPFIRES_TAB = CREATIVE_MODE_TAB.register("tintedcampfires", () -> CreativeModeTab.builder()
    ...
    public static void init(BusGroup busGroup) {
        CREATIVE_MODE_TAB.register(busGroup);
    }
}
